"""Minimal test agent for Chrome DevTools MCP server on App Platform.
...
logger = logging.getLogger("test-cdp")
...
SYSTEM_PROMPT = (
    ...
    "websites, inspect pages, and extract information."
)
...
app = FastAPI(title="Test CDP Agent", lifespan=lifespan)
